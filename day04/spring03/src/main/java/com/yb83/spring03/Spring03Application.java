...
public class Spring03Application {
	...
	public static void main(String[] args) {
		...
		System.out.println(lst1);
		// !중요한 메서드
		// lst1.clrear(); // 로직 중간에 함부로 쓰지 말것!! 프로그램 종료시 리스트를 비우는 것

		// Vector
		Vector<String> vec1 = new Vector<>(10); // 용량을 지정할 수 있음.
		vec1.add("One");
		vec1.add("Three");
		System.out.println("백터 크기 -> " + vec1.size()); 
		System.out.println("백터 용량 -> " + vec1.capacity()); 
		...
		System.out.println(phones.containsKey("010-6666-6622"));
		System.out.println(phones.containsValue("Iphone 11"));
		...
		System.out.println("# 성적 조회할 사람 학생 이름 입력 > ");
