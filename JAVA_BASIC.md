...
- Iteger, Double, Float, Byte 등 대문자로 시작하는 타입이 진짜 Java 클래스 타입
...
- 이런 자료구조를 `Java 컬렉션 프레임 워크`라고 지칭

## Java 컬렉션 프레임 워크
<img src="./image/sb0002.png" width="750">

- List : 순서가 있는 데이터 집합. 데이터 중복 허용
- Set : 수서가 없는 데이터 집합. 데이터 중복 허용 X
- Map : 키와 값 쌍의 데이터 집합. 순서 X, 키 중복 X,  값 중복은 가능
...
- @FunctionalInterface 어노테이션을 사용 권장장
