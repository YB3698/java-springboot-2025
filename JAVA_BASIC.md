...
- 자바 소스코드 구조
  ...
  /* 여러줄
     주석. */
  package com.yb83.spring01; // 자신 프로젝트의 패키지명(폴더)
...
- [java.lang.String](https://docs.oracle.com/en/java/javase/24/docs/api/java.base/java/lang/String)
- String
...
- time
  - 날짜와 시간을 처리할 때 사용
- [Java문법실습](./day04/spring01/src/main/java/com/yb83/spring01/Spring01Application.java)
...
- [Java문법실습](./day04/spring02/src/main/java/com/yb83/spring02/Spring02Application.java)
...
- [Java문법실습](./day04/spring03/src/main/java/com/yb83/spring03/Spring03Application.java)
...
- [Java문법실습](./day04/spring04/src/main/java/com/yb83/spring04/Spring04Application.java)

#### StringBuilder
- String 객체는 불변의 성질. 한번 생성되면 변경불가
- 연산자로 수정을 하면 기존 메모리는 두고, 다시 String 객체를 생성
- 이를 해결하고자 하기 위해 만든 것 - StringBuilder
- 리스트와 유사.  문자열 처리 때문에 메모리 문제, 성능 문제가 발생하면 StirngBuilder, StringBuffer 사용 권장

    ```java
    StringBuilder sb = sew StringBuilder();
    sb.append("Hello");
    sb.append("Java!");
    // inster(), delete()
    ```
[JAVA문법실습](./day05/spring01/src/main/java/com/yb83/spring01/Spring01Application.java)

#### GC(Garbage Collection)
- C등 절차적 언어에서는 객체를 생성해서 메모릴 사용하면, 개발자가 직접 해줘야 함
- 메모리 누수가 발생
...
- 입출력 예외가 발생할 수 있기 때문에 클래스나 메서드에 `throws IOException`을 추가해야됨
- 파일 읽기에 `FileInputStream`, `BufferReader` 클래스 사용

- [JAVA문법실습](./day05/spring02/src/main/java/com/yb83/spring02/Spring02Application.java)
...
#### 2. @Deprecated
- 앞으로 다음버전에서 삭제될 수 있음. 사용하지 말 것을 권유하는 체크
